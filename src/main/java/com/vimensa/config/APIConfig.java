...
public class APIConfig {
    ...
    private static Map<String, _BaseApiHandler> handlers = new HashMap<String, _BaseApiHandler>();
    public static _BaseApiHandler getHandler(String path){
    ...
    public static void init() throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        for(int i = 0; i < arr.size(); i++){
            ...
            _BaseApiHandler handler = (_BaseApiHandler) Class.forName(handlerClassPath).newInstance();
